...
export default defineComponent({
    ...
    props: {
        ...
        startDate: {} as Prop<Date>,
        emdDate: {} as Prop<Date>,
        unavailableDates: [] as Prop<Date[]>,
    },
    setup() {
        return {
    ...
    render() {
        return <div class={"reserve-date"}>
            <div class={"reserve-date__top"}>
                ...
                <button class={"reserve-date__reserve"}>{this.reserveButtonLabel}</button>
            </div>
            <div class={"reserve-date__bottom"}>
                <div class="reserve-dates">
                    <div class="reserve-dates__from">{this.startDate || "Date from"}</div>
                    ...
                    <div class="reserve-dates__to">{this.emdDate || "Date to"}</div>
                </div>
            </div>
        </div>
    }
